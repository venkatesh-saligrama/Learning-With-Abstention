...
class LWANet_RegressorAdapter(RegressorAdapter):
    ...
    def __init__(self,
        ...
        """
        super(LWANet_RegressorAdapter, self).__init__(model, fit_params)
        # Instantiate model
        self.epochs = epochs
        ...
        self.model = torch_models.lwa_regression_model(in_shape=in_shape, hidden_size=hidden_size, dropout=dropout)
        self.loss_func = torch_models.LWA_RegressionLoss( _lambda1, _lambda2 ) #torch.nn.MSELoss()
        self.learner = torch_models.LWA_LearnerOptimized(self.model,
