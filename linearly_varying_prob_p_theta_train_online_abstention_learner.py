...
if __name__ == '__main__':
    ...
    n_runs = 100 #150 #200 #20 #1 #5 #3 #20
    ...
    T = 200 #1000 #2000 #1000 #5000 #10000 #10000
    print('T = ', T)
    print('Thetas = ', Thetas)
    print('Ps = ', Ps)
    print('n_runs = ', n_runs)
    ...
    all_theta_compute_error_bars( T, Thetas, Ps, runs,  return_stats, label='linearly-varying-Ps-0.015-0.3-0.015-thetas-0.001-0.05-0.005-0.015-T-200-' + str(time.time()) )  
