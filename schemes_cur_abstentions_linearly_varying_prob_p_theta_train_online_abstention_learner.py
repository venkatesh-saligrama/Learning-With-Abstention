...
if __name__ == '__main__':
    ...
    n_runs = 70 #100 #150 #200 #20 #1 #5 #3 #20
    ...
    T = 150 #200 #1000 #2000 #1000 #5000 #10000 #10000
    print('T = ', T)
    print('Thetas = ', Thetas)
    print('Ps = ', Ps)
    print('n_runs = ', n_runs)
    ...
    scheme_name = 'algo_abstained * theta  '
    print('Refining scheme = ', scheme_name )
    all_theta_compute_error_bars( T, Thetas, Ps, runs,  return_stats, label='scheme-algo_abs-linearly-varying-runs-70-Ps-0.015-0.3-0.015-thetas-0.001-0.05-0.005-0.015-T-150-' + str(time.time()) )  
