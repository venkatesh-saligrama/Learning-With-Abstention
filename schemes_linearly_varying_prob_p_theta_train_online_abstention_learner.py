...
if __name__ == '__main__':
    ...
    all_theta_compute_error_bars( T, Thetas, Ps, runs,  return_stats, label='linearly-varying-runs-70-Ps-0.015-0.3-0.015-thetas-0.001-0.05-0.005-0.015-T-150-' + str(time.time()) )  
